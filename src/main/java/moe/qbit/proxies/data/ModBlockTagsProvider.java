...
public class ModBlockTagsProvider extends BlockTagsProvider {
   ...
   protected void registerTags() {
      ...
      this.getOrCreateBuilder(ModBlockTags.FLUID_PROXIES).add(ModBlocks.FLUID_PROXY.get(), ModBlocks.SIDED_FLUID_PROXY.get(), ModBlocks.NULLSIDED_FLUID_PROXY.get(), ModBlocks.JUNCTION_FLUID_PROXY.get(), ModBlocks.FILTERED_FLUID_PROXY.get(), ModBlocks.MERGER_FLUID_PROXY.get());
